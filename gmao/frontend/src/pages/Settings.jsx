...
export default function Settings() {
  ...
  const canEditCodification = can('settings', 'update');
  const canEditUnits = can('settings', 'update');
  const canEditKpis = can('settings', 'update');
  const canEditTargets = can('settings', 'update');
